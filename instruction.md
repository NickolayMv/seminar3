...
Выводит в обратном хронологическом порядке список сохраненных в данный репозиторий версий. С каждым коммитов выводится контрольная сумма. Команда для просмотра журнала изменений:
